...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
       double methodResult1 = MyUtil.calculateBMI(60, 1.65);
       double methodResult2 = MyUtil.average(2, 4, 6);
       System.out.println("Print calculateBMI method result: " + methodResult1);
       System.out.println("Print average method result: " +  methodResult2); 
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
          ...
          person1.getId();
          person1.setId(1110);
          System.out.println("Person 1's ID: " + person1.toString());
         ...
         System.out.println("Balance of person1's account: " + account1.getBalance()); 
         
         //withdraw
         account1.withdraw(2000);
         System.out.println("Balance of person1's account after withdraw(2000): " + account1.getBalance()); 
         
         //transfer
         account1.transfer(200, account2);
         System.out.println("Balance of person2's account: " + account2.getBalance()); 
         System.out.println("Balance of person1's account after transfer to account2: " + account1.getBalance()); 
         
         //toStirng
         System.out.println("ID of account2's owner: " + account2.toString()); 
   }
}
